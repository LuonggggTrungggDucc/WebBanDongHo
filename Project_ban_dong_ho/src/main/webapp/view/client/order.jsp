    ...
    <div class="container">
      <div class="row">
      	<div>
      		...
      		<strong>Các bước mua hàng trên Cửa hàng: </strong>
      		<p>
			...
			<p>Cách thức thực hiện cực đơn giản, dễ dàng, và nhanh chóng và có đầy đủ hướng dẫn sẽ tiết kiệm thời gian mua hàng của khách hàng.</p>
      		...
      		<p>Ngoài mua hàng thông qua website, khách hàng cũng có thể đặt hàng các sản phẩm của <strong>Cửa hàng Trung Đức</strong> qua Hotline: 0325776082</p>
