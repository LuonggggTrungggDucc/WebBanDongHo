          ...
          <div class="navbar-collapse collapse">
            ...
            <li><a href="${pageContext.request.contextPath}/view/client/product">SẢN PHẨM</span></a>
                <ul class="dropdown-menu">                
                  <li><a href="product.jsp">ĐỒNG HỒ NAM</a></li>
                  <li><a href="product.jsp">ĐỒNG HỒ NỮ</a></li>
                  <li><a href="product.jsp">ĐỒNG HỒ CHÂU ÂU</a></li>
                  <li><a href="product.jsp">ĐỒNG HỒ NHẬT BẢN</a></li>
                </ul>
              </li>
