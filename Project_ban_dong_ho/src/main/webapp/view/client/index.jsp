              ...
              <div class="col-md-5 no-padding">                
                <div class="aa-promo-left">
                  <div class="aa-promo-banner">                    
                    <img src="${url}/images/products/section1_tc.jpg" alt="Đồng Hồ Orient FAG00002W0 Nam Cơ">                    
                    <div class="aa-prom-content">
                      <span>Giảm giá 35%</span>
                      <h4>Đồng Hồ Orient FAG00002W0 Nam Cơ</h4>                      
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-7 no-padding">
                <div class="aa-promo-right">
                  <div class="aa-single-promo-right">
                    <div class="aa-promo-banner">                      
                      <img src="${url}/images/products/section2_tc.jpg" alt="I&W Carnival 42mm Nam 711G6">                      
                      <div class="aa-prom-content">
                        <span>Sản Phẩm độc quyền</span>
                        <h4>I&W Carnival 42mm Nam 711G6</h4>                        
                      </div>
                    </div>
                  </div>
                  <div class="aa-single-promo-right">
                    <div class="aa-promo-banner">                      
                      <img src="${url}/images/products/section3_tc.jpg" alt="img">                      
                      <div class="aa-prom-content">
                  ...
                  <div class="aa-single-promo-right">
                    <div class="aa-promo-banner">                      
                      <img src="${url}/images/products/section4_tc.jpg" alt="img">                      
                      <div class="aa-prom-content">
                        <span>Giảm giá 25%</span>
                        <h4>Seiko 37mm Nam SNK809K2</h4>                        
                      </div>
                    </div>
                  </div>
                  <div class="aa-single-promo-right">
                    <div class="aa-promo-banner">                      
                      <img src="${url}/images/products/section5_tc.jpg" alt="img">                      
                      <div class="aa-prom-content">
                        <span>Sản phẩm độc quyền</span>
                        <h4>Orient 41.7mm Nam</h4>                        
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="aa-product-inner">
                <!-- start prduct navigation -->
                 <ul class="nav nav-tabs aa-products-tab">
                    <li class="active"><a href="#raucu" data-toggle="tab">Đồng hồ Nam</a></li>
                    <li><a href="#hat" data-toggle="tab">Đồng hồ Nữ</a></li>
                    <li><a href="#traicay" data-toggle="tab">Đồng hồ Châu Âu </a></li>
                    <li><a href="#matong" data-toggle="tab">Đồng hồ Nhật Bản</a></li>
                  </ul>
                  <!-- Tab panes -->
      ...
      <div class="row">
        <div class="col-md-12">        
          <div class="row">
            ...
            <a href="#"><img src="${url}/images/banner_5.jpg" alt="banner trang chủ"></a>
          </div>
          </div>
        </div>
      </div>
          ...
          <div class="aa-testimonial-area">
            <ul class="aa-testimonial-slider">
              ...
              <li>
                ...
                <img class="aa-testimonial-img" src="${url}/images/products/avatar.jpg" alt="avatar 1">
              ...
              <li>
                <div class="aa-testimonial-single">
                <img class="aa-testimonial-img" src="${url}/images/products/avatar.jpg" alt="avatar 2">
                  <span class="fa fa-quote-left aa-testimonial-quote"></span>
              ...
              <li>
                <div class="aa-testimonial-single">
                <img class="aa-testimonial-img" src="${url}/images/products/avatar.jpg" alt="avatar 3">
                  <span class="fa fa-quote-left aa-testimonial-quote"></span>
