              ...
              <div class="col-md-4 col-sm-6">
                <div class="aa-footer-widget">
                  ...
                  <ul class="aa-footer-nav">
                    ...
                    <li><p style="color:#888; text-align: justify; width: 95%">Là nơi chuyên buôn bán tất cả các mặt hàng về đồng hồ chất lượng. Chúng tôi luôn đặt tiêu chí về chất lượng và uy tín lên hàng đầu.</p></li>
              ...
              <div class="col-md-4 col-sm-6">
                <div class="aa-footer-widget">
                  <div class="aa-footer-widget">
                    <h3>LIÊN HỆ</h3>
                    <address>
                      <p>Thủ Sỹ - Tiên Lữ - Hưng Yên</p>
                      <p><span class="fa fa-phone"></span>032.5776.082</p>
                      <p><span class="fa fa-envelope"></span>ducduc27112k1@gmail.com</p>
                    </address>
      ...
      <div class="container">
        ...
        <div class="col-md-12">
          <div class="aa-footer-bottom-area">
            <p>Copyright 2023 &copy Shop Trung Duc</p>
